                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        @if(isset($admin))
                                            ...
                                            @foreach($roles as $role)
                                                <div class="form-check">
                                                    <input value="{{$role->name}}" class="form-check-input" name="roles[]" type="checkbox" <?php if(in_array($role->name, $userRole)) echo 'checked' ?>>
                                        ...
                                        @else
                                            ...
                                            @foreach($roles as $role)
                                                <div class="form-check">
                                                    <input value="{{$role->name}}" class="form-check-input" name="roles[]" type="checkbox">
                                                    <label class="form-check-label">{{$role->name}}</label>
                                                </div>
                                            @endforeach
