                ...
                <div class="card card-primary card-outline card-outline-tabs">
                  <div class="card-header p-0 border-bottom-0">
                    <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
                      <li class="nav-item" {{ $offer->type == 'promocode' ?'':'hidden'}}>
                      ...
                      <li class="nav-item" {{ $offer->type == 'point' ?'':'hidden'}}>
                  ...
                  <div class="card-body">
                    <div class="tab-content" id="custom-tabs-three-tabContent">
                      <div class="tab-pane fade {{ $offer->type == 'promocode' ?'show active':'hidden'}}" id="custom-tabs-three-home" role="tabpanel" aria-labelledby="custom-tabs-three-home-tab">
                      ...
                      <div class="tab-pane fade {{ $offer->type == 'point' ?'show active':'hidden'}}" id="custom-tabs-three-settings" role="tabpanel" aria-labelledby="custom-tabs-three-settings-tab">
                           @include('Admin.offers._product_point_edit') 
                      </div>
                    </div>
                  </div>
